...
// Subcomponents (assumed to exist, update as needed)
...
const TicketForm = ({ organization, token }) => {
  ...
  const handleChange = useCallback(
    (e) => {
      ...
      if (name === "urgency") calculatePriority(updated);
    },
    [formData]
  );
    ...
    <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 py-6 bg-white shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <DescriptionSection
          ...
          handleAttachmentChange={handleAttachmentChange} // Pass the new handler
          loading={loading}
        />
