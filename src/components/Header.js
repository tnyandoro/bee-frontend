    ...
    <div className="preview__header">
      <div className="preview__envato-logo">
        <a
          ...
          href="https://themeforest.net/item/annakoot-react-admin-panel/54332909"
        >
          GSS ITSM
        </a>
      </div>
      <div id="js-preview__actions" className="preview__actions">
        <div className="preview__action--buy">
          <a
            ...
            href="https://themeforest.net/checkout/from_item/54332909?license=regular&amp;support=bundle_6month"
          >
            Buy now
          </a>
        </div>
